...
@app.route('/')
def index():
    pegawai_tetap = PegawaiTetap("Park Jimin", "951013", "A", 7500000)
    pegawai_harian = PegawaiHarian("Kim Taehyung", "951230", "B", 120, 6000)
    pegawai_kontrak = PegawaiKontrak("Jung Jungkook", "971102", "C", 6, 3000000)
